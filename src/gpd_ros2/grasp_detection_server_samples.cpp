...
bool GraspDetectionServer::DetectGrasps(gpd_ros2::DetectGraspsSamples::Request& req, gpd_ros2::DetectGraspsSamples::Response& res)
{
...
int main(int argc, char** argv)
{
  ...
  ros::ServiceServer service = node.advertiseService("DetectGraspsSamples", &GraspDetectionServer::DetectGrasps,
